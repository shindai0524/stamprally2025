...
<!-- メニューリスト内の warning -->
  ...
  <div id="helpViewer" class="hidden">
    <div class="help-viewer">
      ...
      <!-- メイン画像 -->
      <img id="helpImage" src="image/qr22.png" alt="ヘルプ画像" class="help-image"/>

      <!-- ▼ QR 2枚目専用の説明エリア -->
      <div id="qrSecondText" class="qr-text hidden">
        <b style="font-size: 1.1.em">以下の「アイヌ関連施設または史跡」の二次元コードは各施設・史跡付近に設置されている説明看板に掲示しています。</b>
        <p>
          ①愛隣学校跡<br>
          ②知里幸恵の墓・金成マツの碑<br>
          ③アフンルパル<br>
...
<div id="popup" class="popup hidden">
  ...
  <script src="home_test.js"></script>
</body>
</html>